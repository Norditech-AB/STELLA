...
class Task:
    ...
    def execute(self, agent_storage: AgentStorage, openai_client: OpenAIClient, socketio,
        ...
        if not current_agent.skip_action_selection and action_map:
            # TODO: Wrap the .select_action method with a timeout, and if it doesn't finish within 5 seconds
            # TODO: emit a message to the user that OpenAI is taking longer than expected to respond. (not fatal)
        ...
        if selected_action == "0":
            ...
            if not current_agent.skip_response:
                # TODO: Wrap the .respond method with a timeout, and if it doesn't finish within 5 seconds
                # TODO: emit a message to the user that OpenAI is taking longer than expected to respond. (not fatal)
                ...
                # (Save the response to task memory)
                # TODO: Add more information to memories, like source etc. (and IDs to prevent duplicates)
